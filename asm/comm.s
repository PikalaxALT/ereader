...
sub_0803B634: @ 0x0803B634
	...
	adds r4, r1, #0
	adds r5, r2, #0
	ldr r0, _0803B650 @ =gUnknown_3003E50
	ldrb r0, [r0, #1]
	cmp r0, #4
	bhi _0803B732
	lsls r0, r0, #2
	...
	mov pc, r0
	.align 2, 0
_0803B650: .4byte gUnknown_3003E50
...
_0803B66C:
	ldr r0, _0803B6AC @ =gUnknown_3003E38
	...
	mov r0, sp
	str r0, [r1]
	ldr r2, _0803B6C8 @ =gUnknown_3003E50
	str r2, [r1, #4]
	...
	b _0803B732
	.align 2, 0
_0803B6AC: .4byte gUnknown_3003E38
...
_0803B6C8: .4byte gUnknown_3003E50
...
_0803B6D0:
	...
	bne _0803B732
	bl sub_0803B58C
	ldr r1, _0803B6E4 @ =gUnknown_3003E50
	movs r0, #2
	strb r0, [r1, #1]
	b _0803B732
	.align 2, 0
_0803B6E4: .4byte gUnknown_3003E50
_0803B6E8:
	ldrb r0, [r6]
	cmp r0, #1
	beq _0803B6F8
	...
	b _0803B732
_0803B6F8:
	ldr r1, _0803B70C @ =gUnknown_3003E50
	ldrb r2, [r1]
	cmp r2, #8
	bne _0803B732
	ldrb r2, [r1, #3]
	...
	b _0803B732
	.align 2, 0
_0803B70C: .4byte gUnknown_3003E50
_0803B710:
	ldr r1, _0803B718 @ =gUnknown_3003E50
	movs r0, #0
	strb r0, [r1, #1]
	b _0803B732
	.align 2, 0
_0803B718: .4byte gUnknown_3003E50
_0803B71C:
	bl sub_0803BED8
	ldr r1, _0803B774 @ =gUnknown_3003E50
	movs r0, #4
	strb r0, [r1, #1]
_0803B726:
	adds r0, r4, #0
...
_0803B732:
	movs r0, #0
	strb r0, [r6]
	ldr r0, _0803B774 @ =gUnknown_3003E50
	ldrb r2, [r0, #3]
	lsls r1, r2, #2
	ldrb r2, [r0, #2]
	orrs r1, r2
...
_0803B74C:
	...
	b _0803B77C
	.align 2, 0
_0803B774: .4byte gUnknown_3003E50
_0803B778:
	adds r0, r1, #0
	orrs r0, r3
_0803B77C:
	...
	orrs r0, r1
	adds r1, r0, #0
	ldr r0, _0803B7A8 @ =gUnknown_3003E40
	ldrb r0, [r0, #1]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	ldrb r2, [r2, #2]
...
_0803B79E:
	...
	bx r1
	.align 2, 0
_0803B7A8: .4byte gUnknown_3003E40
...
sub_0803B7AC: @ 0x0803B7AC
	...
	push {r5, r6, r7}
	adds r4, r0, #0
	ldr r2, _0803B82C @ =gUnknown_3003E38
	ldr r1, _0803B830 @ =REG_IME
	ldrh r0, [r1]
	strh r0, [r2]
	movs r0, #0
	strh r0, [r1]
	ldr r0, _0803B834 @ =gUnknown_3003E50
	adds r1, r0, #0
	adds r1, #0x91
	mov ip, r0
	ldrb r0, [r1]
...
_0803B7E2:
	...
	lsrs r1, r0, #0x18
	movs r3, #0
	ldr r5, _0803B838 @ =gUnknown_3003E40
	movs r0, #0
	ldrsb r0, [r5, r0]
	ldr r2, _0803B83C @ =gUnknown_3003E22
	mov sb, r2
	ldr r2, _0803B840 @ =gUnknown_3003E30
	mov sl, r2
	cmp r3, r0
	bge _0803B856
	mov r2, sb
	lsls r6, r1, #1
	ldr r0, _0803B844 @ =gUnknown_3003E68
	mov r8, r0
	movs r7, #0
_0803B804:
	ldrh r1, [r4]
	...
	b _0803B856
	.align 2, 0
_0803B82C: .4byte gUnknown_3003E38
_0803B830: .4byte REG_IME
_0803B834: .4byte gUnknown_3003E50
_0803B838: .4byte gUnknown_3003E40
_0803B83C: .4byte gUnknown_3003E22
_0803B840: .4byte gUnknown_3003E30
_0803B844: .4byte gUnknown_3003E68
_0803B848:
	movs r0, #1
	mov r1, ip
	strb r0, [r1, #0x12]
	ldr r2, _0803B890 @ =gUnknown_3003E22
	mov sb, r2
	ldr r0, _0803B894 @ =gUnknown_3003E30
	mov sl, r0
_0803B856:
	mov r1, sb
	ldrh r0, [r1]
...
_0803B86E:
	...
	ldr r2, _0803B89C @ =gUnknown_3003E38
	ldrh r0, [r2]
	strh r0, [r1]
	mov r0, ip
	adds r0, #0x91
	...
	bx r0
	.align 2, 0
_0803B890: .4byte gUnknown_3003E22
_0803B894: .4byte gUnknown_3003E30
_0803B898: .4byte REG_IME
_0803B89C: .4byte gUnknown_3003E38
...
sub_0803B8A0: @ 0x0803B8A0
	...
	push {r5, r6, r7}
	mov r8, r0
	ldr r2, _0803B910 @ =gUnknown_3003E38
	ldr r1, _0803B914 @ =REG_IME
	ldrh r0, [r1]
	strh r0, [r2]
	movs r0, #0
	strh r0, [r1]
	ldr r1, _0803B918 @ =gUnknown_3003E50
	...
	bne _0803B924
	movs r3, #0
	ldr r0, _0803B920 @ =gUnknown_3003E40
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r3, r0
...
_0803B906:
	...
	b _0803B9A2
	.align 2, 0
_0803B910: .4byte gUnknown_3003E38
_0803B914: .4byte REG_IME
_0803B918: .4byte gUnknown_3003E50
_0803B91C: .4byte 0x00000395
_0803B920: .4byte gUnknown_3003E40
_0803B924:
	movs r3, #0
	ldr r0, _0803B9B8 @ =gUnknown_3003E40
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r3, r0
...
_0803B93A:
	...
	mov r4, r8
	adds r6, r0, r4
	ldr r0, _0803B9BC @ =gUnknown_30041E4
	ldrb r0, [r0]
	lsls r1, r0, #1
	lsls r0, r3, #4
	adds r4, r1, r0
	ldr r1, _0803B9C0 @ =gUnknown_3003E50
	ldrb r3, [r1, #3]
	ldr r7, _0803B9C4 @ =gUnknown_3003EE4
_0803B958:
	lsls r0, r2, #1
	adds r1, r0, r6
	adds r0, r0, r2
...
_0803B9A2:
	...
	ldr r2, _0803B9D0 @ =gUnknown_3003E38
	ldrh r0, [r2]
	strh r0, [r1]
	pop {r3, r4, r5}
	mov r8, r3
	...
	bx r0
	.align 2, 0
_0803B9B8: .4byte gUnknown_3003E40
_0803B9BC: .4byte gUnknown_30041E4
_0803B9C0: .4byte gUnknown_3003E50
_0803B9C4: .4byte gUnknown_3003EE4
_0803B9C8: .4byte 0x00000395
_0803B9CC: .4byte REG_IME
_0803B9D0: .4byte gUnknown_3003E38
	thumb_func_end sub_0803B8A0

	thumb_func_start sub_0803B9D4
sub_0803B9D4: @ 0x0803B9D4
	push {lr}
	ldr r2, _0803BA08 @ =gUnknown_3003E50
	ldrb r0, [r2]
	cmp r0, #0
	beq _0803BA24
	ldrb r0, [r2, #1]
	...
	cmp r0, #4
	bne _0803BA24
	ldr r0, _0803BA0C @ =gUnknown_3003E40
	movs r1, #0xd
	ldrsb r1, [r2, r1]
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	...
	b _0803BA24
	.align 2, 0
_0803BA08: .4byte gUnknown_3003E50
_0803BA0C: .4byte gUnknown_3003E40
_0803BA10:
	movs r0, #0
	strb r0, [r2, #0xd]
	bl sub_0803BF40
	b _0803BA24
_0803BA1A:
	ldr r0, _0803BA28 @ =gUnknown_3003E40
	ldrb r0, [r0]
	strb r0, [r2, #0xd]
	bl sub_0803BF40
_0803BA24:
...
sub_0803BA2C: @ 0x0803BA2C
	...
	b _0803BA78
	.align 2, 0
_0803BA58: .4byte gUnknown_3003E50
...
_0803BA76:
	strb r0, [r4, #1]
_0803BA78:
	ldr r1, _0803BA98 @ =gUnknown_3003E50
	ldrb r0, [r1, #0xd]
	adds r0, #1
	strb r0, [r1, #0xd]
	lsls r0, r0, #0x18
	...
	cmp r0, #0xc
	bne _0803BA92
	ldr r0, _0803BA9C @ =gUnknown_3003E34
...
_0803BA92:
	...
	bx r0
	.align 2, 0
_0803BA98: .4byte gUnknown_3003E50
_0803BA9C: .4byte gUnknown_3003E34
...
sub_0803BAA4: @ 0x0803BAA4
	...
	ldr r0, _0803BAC8 @ =gUnknown_3003E50
	adds r7, r0, #0
	ldrb r0, [r7, #0xe]
	cmp r0, #1
	bne _0803BAD4
...
_0803BAC8: .4byte gUnknown_3003E50
_0803BACC: .4byte REG_SIOMLT_SEND
_0803BAD0: .4byte 0x00008FFF
_0803BAD4:
	ldr r0, _0803BAFC @ =REG_SIOMLT_SEND
	ldr r1, _0803BB00 @ =gUnknown_3003E40
	ldrh r1, [r1, #6]
	strh r1, [r0]
_0803BADC:
	ldr r2, _0803BB04 @ =gUnknown_3003E54
...
_0803BB00: .4byte gUnknown_3003E40
_0803BB04: .4byte gUnknown_3003E54
_0803BB08: .4byte REG_SIOMLT_RECV
_0803BB0C: .4byte 0x00008FFF
_0803BB10:
	movs r3, #0
	ldr r0, _0803BB3C @ =gUnknown_3003E40
	movs r6, #4
	negs r6, r6
	adds r1, r6, #0
	ldrh r0, [r0, #6]
...
_0803BB24:
	...
	b _0803BB60
	.align 2, 0
_0803BB3C: .4byte gUnknown_3003E40
...
sub_0803BB80: @ 0x0803BB80
	...
	mov r5, r8
	push {r5, r6, r7}
	ldr r0, _0803BBC8 @ =gUnknown_3003E50
	ldrb r1, [r0, #0x16]
	adds r4, r0, #0
	cmp r1, #0
	bne _0803BBD0
...
_0803BBC2:
	...
	b _0803BC8C
	.align 2, 0
_0803BBC8: .4byte gUnknown_3003E50
...
_0803BBE6:
	...
	bhi _0803BC60
	movs r3, #0
	ldr r7, _0803BC54 @ =gUnknown_3003E40
	mov sl, r7
	ldrb r0, [r4, #3]
	cmp r3, r0
	bhs _0803BC68
	mov ip, r4
	ldr r2, _0803BC58 @ =gUnknown_3003E24
	mov r8, r2
	lsls r1, r1, #1
	mov sb, r1
_0803BC0A:
...
_0803BC54: .4byte gUnknown_3003E40
_0803BC58: .4byte gUnknown_3003E24
_0803BC5C: .4byte REG_SIOMLT_RECV
_0803BC60:
	movs r0, #2
	strb r0, [r4, #0x12]
	ldr r7, _0803BC9C @ =gUnknown_3003E40
	mov sl, r7
_0803BC68:
	ldrb r0, [r4, #0x17]
	adds r0, #1
	...
	cmp r0, r1
	bne _0803BC8C
	ldr r2, _0803BCA0 @ =gUnknown_3003E24
	ldrh r0, [r2]
	cmp r0, #0
	beq _0803BC8C
...
_0803BC8C:
	...
	bx r0
	.align 2, 0
_0803BC9C: .4byte gUnknown_3003E40
_0803BCA0: .4byte gUnknown_3003E24
...
sub_0803BCA8: @ 0x0803BCA8
	push {r4, lr}
	ldr r1, _0803BCE4 @ =gUnknown_3003E50
	ldr r0, _0803BCE8 @ =gUnknown_3003E40
	adds r3, r1, #0
	ldrb r1, [r3, #0x16]
	ldrb r0, [r0]
	cmp r1, r0
	...
	ldrh r0, [r3, #0x14]
	strh r0, [r1]
	ldr r1, _0803BCF0 @ =gUnknown_3003E20
	ldrb r2, [r1]
	cmp r2, #0
	bne _0803BCF4
	adds r1, r3, #0
	...
	b _0803BD4A
	.align 2, 0
_0803BCE4: .4byte gUnknown_3003E50
_0803BCE8: .4byte gUnknown_3003E40
_0803BCEC: .4byte REG_SIOMLT_SEND
_0803BCF0: .4byte gUnknown_3003E20
_0803BCF4:
	movs r0, #0
	strb r0, [r1]
	b _0803BD4A
_0803BCFA:
	ldr r1, _0803BD20 @ =gUnknown_3003E20
	ldrb r0, [r1]
	cmp r0, #0
	bne _0803BD16
	adds r0, r3, #0
...
_0803BD16:
	...
	b _0803BD44
	.align 2, 0
_0803BD20: .4byte gUnknown_3003E20
...
sub_0803BD54: @ 0x0803BD54
	push {r4, r5, r6, r7, lr}
	ldr r1, _0803BDA8 @ =gUnknown_3003E50
...
_0803BD7E:
	...
	bx r0
	.align 2, 0
_0803BDA8: .4byte gUnknown_3003E50
...
sub_0803BDB4: @ 0x0803BDB4
	push {r4, r5, lr}
	sub sp, #4
	ldr r0, _0803BDFC @ =gUnknown_3003E38
	...
	mov r0, sp
	str r0, [r1]
	ldr r0, _0803BE18 @ =gUnknown_3003E50
	str r0, [r1, #4]
	...
	bx r0
	.align 2, 0
_0803BDFC: .4byte gUnknown_3003E38
...
sub_0803BE20: @ 0x0803BE20
	...
	bx lr
	.align 2, 0
_0803BE3C: .4byte gUnknown_3003E40
...
sub_0803BE40: @ 0x0803BE40
	...
	sub sp, #4
	bl sub_0803B58C
	ldr r0, _0803BE8C @ =gUnknown_3003E38
	...
	mov r0, sp
	str r0, [r1]
	ldr r0, _0803BEA8 @ =gUnknown_3003E50
	str r0, [r1, #4]
	...
	bx r0
	.align 2, 0
_0803BE8C: .4byte gUnknown_3003E38
...
_0803BEA8: .4byte gUnknown_3003E50
...
sub_0803BEB0: @ 0x0803BEB0
	...
	movs r0, #0xc
	ands r1, r0
	ldr r2, _0803BECC @ =gUnknown_3003E50
	cmp r1, #8
	bne _0803BED0
	ldrb r0, [r2, #2]
	cmp r0, #0
...
_0803BECC: .4byte gUnknown_3003E50
_0803BED0:
	movs r0, #0
	strb r0, [r2]
_0803BED4:
...
sub_0803BED8: @ 0x0803BED8
	push {r4, lr}
	ldr r0, _0803BF18 @ =gUnknown_3003E50
	ldrb r0, [r0]
	cmp r0, #0
	beq _0803BF10
	ldr r1, _0803BF1C @ =REG_TM3CNT_L
	ldr r2, _0803BF20 @ =gUnknown_3003E40
	...
	orrs r0, r4
	strh r0, [r1]
	ldr r0, _0803BF28 @ =gUnknown_3003E38
...
_0803BF10:
	...
	bx r0
	.align 2, 0
_0803BF18: .4byte gUnknown_3003E50
_0803BF1C: .4byte REG_TM3CNT_L
_0803BF20: .4byte gUnknown_3003E40
_0803BF24: .4byte 0x0000FFFF
_0803BF28: .4byte gUnknown_3003E38
...
sub_0803BF50: @ 0x0803BF50
	ldr r0, _0803BF74 @ =gUnknown_3003E50
	ldrb r0, [r0]
	cmp r0, #0
	beq _0803BF70
	...
	strh r0, [r2]
	subs r2, #2
	ldr r1, _0803BF80 @ =gUnknown_3003E40
...
sub_0803BF88: @ 0x0803BF88
	...
	b _0803BFB4
	.align 2, 0
_0803BF9C: .4byte gUnknown_3003E50
_0803BFA0: .4byte gUnknown_3003E40
_0803BFA4:
	ldrb r0, [r1]
	cmp r0, #0
	beq _0803BFB4
...
sub_0803BFBC: @ 0x0803BFBC
	push {r4, r5, lr}
	ldr r2, _0803BFFC @ =gUnknown_3003E50
	adds r0, r2, #0
	adds r0, #0x91
	movs r1, #0
	strb r1, [r0]
...
_0803BFDC:
	...
	bx r0
	.align 2, 0
_0803BFFC: .4byte gUnknown_3003E50
